function mix = test(child,sizes,k,power,speed,duration,strength,width,depth)
...
t = sizes(5,2);
u = sizes(6,2);
mix = [de2bi(ceil(pow(1)*k(1)),p) de2bi(round(pow(2)*k(1)),p) de2bi(floor(pow(3)*k(1)),p) de2bi(ceil(spe(1)*k(2)),q) de2bi(round(spe(2)*k(2)),q) de2bi(floor(spe(3)*k(2)),q) de2bi(ceil(dur(1)*k(3)),r) ...
    de2bi(round(dur(2)*k(3)),r) de2bi(floor(dur(3)*k(3)),r) de2bi(ceil(str(1)*k(4)),s) de2bi(round(str(2)*k(4)),s) de2bi(floor(str(3)*k(4)),s) de2bi(ceil(wid(1)*k(5)),t) de2bi(round(wid(2)*k(5)),t) ...
    de2bi(floor(wid(3)*k(5)),t) de2bi(ceil(dep(1)*k(6)),u) de2bi(round(dep(2)*k(6)),u) de2bi(floor(dep(3)*k(6)),u)];
